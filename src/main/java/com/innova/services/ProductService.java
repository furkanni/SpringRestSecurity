...
//    @DeleteMApping ==> delete
    ...
    public List<ProductDto> getXmlList(){
        ...
        productDtoList.add(ProductDto.builder().productId(0L).productName("ürün 1").productPrice(6000).build());
        productDtoList.add(ProductDto.builder().productId(0L).productName("ürün 1").productPrice(7000).build());
        return productDtoList;
    }

    // http://localhost:8080/rest/json/
    @GetMapping(value = "/rest/jason",produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public ResponseEntity<?> getStatus2(@PathVariable(name="id")Long id){
        ProductDto productDto = ProductDto.builder().productId(0L).productName("Telefon 2").productPrice(7000).build();
    ...
    public ResponseEntity<?> getStatus4(@PathVariable(name="id")Long id){
        ProductDto productDto = ProductDto.builder().productId(0L).productName("Telefon 3").productPrice(8000).build();
